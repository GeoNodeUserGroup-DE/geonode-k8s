...
| geonode.general.session_expired_control_enabled | bool | `true` | DEFAULT_ANONYMOUS_VIEW_PERMISSION: Whether the uploaded resources should be public by default. |
